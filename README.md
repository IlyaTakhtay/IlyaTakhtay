...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=F75C7E&center=true&vCenter=true&width=435&lines=Backend+Developer;Data+Engineer;CTF+Enjoyer)](https://git.io/typing-svg)
...
<div align="center">
  <p>
    ...
    <a href="#"><img src="https://img.shields.io/badge/-Kafka-231F20?style=for-the-badge&logo=apachekafka&logoColor=white" /></a>
...
Multiplayer card game with real-time WebSocket connections  
`FastAPI` `Redis` `WebSocket` `pytest` `Docker`
